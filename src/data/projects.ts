...
export const projects: Project[] = [
  {
    ...
    description: '[Короткий опис проєкту: Замініть цим текстом на фактичний опис проєкту, його особливості та значення.]',
    coverImage: 'https://images.pexels.com/photos/28855196/pexels-photo-28855196.jpeg?auto=compress&cs=tinysrgb&w=1920',
    featured: true,
    gallery: [
    ...
    about: '[Опис проєкту: Детальний опис проєкту, його контексту, інженерних викликів та архітектурних рішень. Замініть цей текст на фактичний контент проєкту.]',
    technical: [
  ...
  },
  {
    ...
    description: '[Короткий опис проєкту: Замініть цим текстом на фактичний опис проєкту.]',
    coverImage: 'https://images.pexels.com/photos/36924968/pexels-photo-36924968.jpeg?auto=compress&cs=tinysrgb&w=1920',
    featured: true,
    gallery: [
    ...
    about: '[Опис проєкту: Детальний опис проєкту. Замініть цей текст на фактичний контент.]',
    technical: [
      { label: 'Довжина', value: '[значення]' },
      { label: 'Ширина', value: '[значення]' },
      { label: 'Висота', value: '[значення]' },
  ...
  },
  {
    ...
    category: 'Естакада',
    description: '[Короткий опис проєкту: Замініть цим текстом на фактичний опис проєкту.]',
    coverImage: 'https://images.pexels.com/photos/38202276/pexels-photo-38202276.jpeg?auto=compress&cs=tinysrgb&w=1920',
    featured: false,
    gallery: [
  ...
  },
  {
    ...
    description: '[Короткий опис проєкту: Замініть цим текстом на фактичний опис проєкту.]',
    coverImage: 'https://images.pexels.com/photos/19626459/pexels-photo-19626459.jpeg?auto=compress&cs=tinysrgb&w=1920',
    featured: false,
    gallery: [
  ...
  },
  {
    ...
    description: '[Короткий опис проєкту: Замініть цим текстом на фактичний опис проєкту.]',
    coverImage: 'https://images.pexels.com/photos/6594786/pexels-photo-6594786.jpeg?auto=compress&cs=tinysrgb&w=1920',
    featured: false,
    gallery: [
  ...
  },
  {
    ...
    description: '[Короткий опис проєкту: Замініть цим текстом на фактичний опис проєкту.]',
    coverImage: 'https://images.pexels.com/photos/31728577/pexels-photo-31728577.jpeg?auto=compress&cs=tinysrgb&w=1920',
    featured: false,
    gallery: [
...
export const heroImage = 'https://images.pexels.com/photos/28855196/pexels-photo-28855196.jpeg?auto=compress&cs=tinysrgb&w=1920';
export const aboutImage = 'https://images.pexels.com/photos/4740155/pexels-photo-4740155.jpeg?auto=compress&cs=tinysrgb&w=1920';
export const visualBreakImage = 'https://images.pexels.com/photos/38487655/pexels-photo-38487655.jpeg?auto=compress&cs=tinysrgb&w=1920';
